...
#define  DEVICE_NAME "mydev1"   ///< In this implementation, the device name has nothing to do with the name of the device in /dev.
//  You must use mknod to create the device node in /dev
